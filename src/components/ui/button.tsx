...
export const BRAND_BUTTON_CLASSES =
  "inline-flex min-h-[44px] items-center justify-center bg-[#5EEAD4] text-[#0F1729] transition hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-teal-200";
